<div class="column-1-4-3-1" role="main-content" id="main">
...
<div class="portlet-layout row-fluid">
	...
	<div class="portlet-column portlet-column-first span4" id="column-6">
	...
	<div class="portlet-column portlet-column-first span4" id="column-8">
